        ...
        <Dialog open={open} onOpenChange={handleOpenChange}>
            <DialogContent className="max-w-[600px] p-0 gap-0">
                <DialogHeader className="px-6 pt-6 pb-4">
                    <DialogTitle className="text-xl font-normal">Contact Support</DialogTitle>
                </DialogHeader>
                ...
                <div className="px-6 pb-6 space-y-5">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex">
                            ...
                            <div className="relative">
                                ...
                                <Button
                                    type="button"
                                    className="bg-[#7C2D3A] hover:bg-[#6B2532] text-white h-10 px-6 rounded-l-none"
                                    disabled={supportMutation.isPending}
                                >
                                    Upload
                                </Button>
                    ...
                    <div className="flex justify-end gap-3 pt-4">
                        ...
                        <Button
                            ...
                            className="bg-[#7C2D3A] hover:bg-[#6B2532] text-white px-8"
                            disabled={supportMutation.isPending}
                        >
